...
export function CommandList({ className, ...props }: ComponentProps<typeof BaseCommand.List>) {
  return <BaseCommand.List className={cn("max-h-60 overflow-y-auto p-1", className)} {...props} />;
}

export function CommandEmpty({ className, ...props }: ComponentProps<typeof BaseCommand.Empty>) {
  return <BaseCommand.Empty className={cn("py-6 text-center text-sm text-slate-400", className)} {...props} />;
}

export function CommandGroup({ className, ...props }: ComponentProps<typeof BaseCommand.Group>) {
  return <BaseCommand.Group className={cn("overflow-hidden p-1 text-slate-200", className)} {...props} />;
}
